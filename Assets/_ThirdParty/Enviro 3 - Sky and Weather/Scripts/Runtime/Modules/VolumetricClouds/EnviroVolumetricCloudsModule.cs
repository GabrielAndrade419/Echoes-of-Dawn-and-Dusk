    ...
    {   
        ...
        if(GraphicsSettings.GetRenderPipelineSettings< UnityEngine.Rendering.Universal.RenderGraphSettings>().enableRenderCompatibilityMode)
           ...
           renderer.raymarchMat = new Material(Shader.Find("Hidden/EnviroCloudsRaymarchURP"));
            ...
            renderer.raymarchMat.SetVector("_CloudsNoiseSettings", new Vector4(layer1.baseNoiseUV, layer1.detailNoiseUV, layer1.baseNoiseMultiplier, layer1.detailNoiseMultiplier));
            ...
            renderer.raymarchMat.SetVector("_CloudsLightingExtended", new Vector4(layer1.directIndirectBalance, layer1.curlIntensity, layer1.lightStepModifier, layer1.absorbtion));   
