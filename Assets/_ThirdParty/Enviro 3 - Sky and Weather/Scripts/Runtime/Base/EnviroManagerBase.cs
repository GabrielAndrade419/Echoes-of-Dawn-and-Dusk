...
namespace Enviro
{
    ...
    public class EnviroManagerBase : MonoBehaviour
    {
        ...
        private string defaultConfig = "Default Enviro Configuration 3_3_0";
                ...
                if(fromVersion != version)
                {
                    if (fromVersion == "")
                    {
                        if (configuration.volumetricCloudModule != null)
                        {
                            ...
                            configuration.volumetricCloudModule.settingsVolume.lightStepModifier = defaults.volumetricCloudModule.settingsVolume.lightStepModifier;
